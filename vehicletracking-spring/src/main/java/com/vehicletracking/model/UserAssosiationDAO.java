...
/**
 * @Class UserAssosiationDAO - is working as a Data Access Object, used to
...
public class UserAssosiationDAO {
	...
	public List<UserAssosiation> getAllUserAssosiations() {
		...
		return entityManager.createQuery("from UserAssosiation")
				.getResultList();
	}
	...
	public UserAssosiation getOneUserAssosiation(int userAssosiationId) {
		...
		userAssosiation = (UserAssosiation) entityManager.find(
				UserAssosiation.class, userAssosiationId);
		return userAssosiation;
	}

	@SuppressWarnings("unchecked")
	public List<UserAssosiation> getFilteredUserAssosiations(
			String app_user_master_id) {
		logger.info("inside getFilteredUserAssosiations method......");
		return entityManager
				.createQuery(
						"from UserAssosiation where APP_USER_MASTER_ID = :app_user_master")
				.setParameter("app_user_master", app_user_master_id)
				.getResultList();
	}
}
