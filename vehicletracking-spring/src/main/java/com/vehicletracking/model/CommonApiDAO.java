...
/**
 * The CommonApiDAO program implements an application that simply displays
 * "CommonApiDAO Details!"
 * 
...
public class CommonApiDAO {
	...
	/**
	 * @method getUserAssosiationListByType -is used to get the user
	 *         assosiations from database.
	 * @param type
	...
	public List<UserAssosiation> getUserAssosiationListByType(char type) {
		...
		userAssosiations = entityManager
				.createQuery("from UserAssosiation where type = :type")
				.setParameter("type", type).getResultList();
		return userAssosiations;
	}

	/**
	 * @method saveUserAssosiation -is used to persist the userAssosiation into
	 *         database
