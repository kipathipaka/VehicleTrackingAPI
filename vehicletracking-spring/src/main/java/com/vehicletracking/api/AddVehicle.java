...
public class AddVehicle {
	...
	/**
	 * @method getVehicleList -is used to get the VehicleList and return the
	 *         response
	...
	public Response getVehiclesList() {
		...
		ArrayList<Vehicle> vehiclesList = (ArrayList<Vehicle>) vehicleDAO
				.getAllVehicles();
	...
	/**
	 * @method getOneVehicle -used to get the vehicleid and create the vehicle
	 *         object.
	 * @param vehicleId
	...
	/**
	 * @method saveVehicle -used to create/save the vehicle and create the
	...
	/**
	 * @method UpdateUser -used to update the user details and create the
	 *         vehicle object
