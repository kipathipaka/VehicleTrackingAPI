...
public class AddVehicleTripDetail {
	...
	public  Response saveVehicleTripDetail(
		...
		VehicleTripDetail savedVehicleTripDetail = vehicleTripDetailDAO.createVehicleTripDetail(vehicleTripDetail);
	...
	public  Response UpdateVehicleTripDetail(@FormParam("vehicle_trip_header_detail_id") int vehicleTripDetailId,
		...
		VehicleTripDetail updatedVehicleTripDetail = vehicleTripDetailDAO.updateVehicleTripDetail(vehicleTripDetail);
